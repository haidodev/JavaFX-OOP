...
public class FestivalModel extends Model
{
    ...
    private String cacNhanVatLienQuan;
    private String toChucLanDau;
    private String diaDanhCode;

    public FestivalModel(String name, String thoiGian, String diaDiem,
                         String cacNhanVatLienQuan, String toChucLanDau, List<String> description, String diaDanhCode)
    {
    ...
    public void setCacNhanVatLienQuan(String cacNhanVatLienQuan)
    {
        this.cacNhanVatLienQuan = cacNhanVatLienQuan.equals("") ? Config.nullRepresentation : cacNhanVatLienQuan;
    }
    ...
    public String toHTML()
    {
        ...
        if (this.cacNhanVatLienQuan != null)
        {
            ...
            htmlBuilder.append("<li>").append(this.cacNhanVatLienQuan).append("</li>");
            htmlBuilder.append("</ul>");
        }
    ...
    public String toString()
    {
        return  "{ \t\"Id\": \"" + this.id + "\", \n\t"
                ...
                + "\"Nhân Vật Lịch Sử Liên Kết\": \"" + this.cacNhanVatLienQuan + "\",\n\t"
